...
public class Constants : MonoBehaviour
{
    ...
    public const int PLAY_SCENE_TOP_DOWN_VIEW = 3;
    public const int PLAY_SCENE_WALL_VIEW = 4;
    public const int PAUSE_SCENE = 5;
    public const int GAME_OVER_SCENE = 6;
    public const int OPTION_SCENE = 7;
    public const int CREDIT_SCENE = 8;
