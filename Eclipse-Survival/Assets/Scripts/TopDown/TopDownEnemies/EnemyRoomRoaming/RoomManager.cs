...
public class RoomManager : MonoBehaviour
{
    ...
    [Header("Set Dynamicaly: Spider Room List")]
    public Room[] spiderRoomList;
    ...
    public Room FindNextRoomSpider(Room currentRoom)
    {
        ...
        while (!completed)
        {
            roomIndex = Random.Range(0, spiderRoomList.Length);

            if (spiderRoomList[roomIndex].sceneName == currentRoom.southSceneName ||
                spiderRoomList[roomIndex].sceneName == currentRoom.westSceneName ||
                spiderRoomList[roomIndex].sceneName == currentRoom.northSceneName ||
                spiderRoomList[roomIndex].sceneName == currentRoom.eastSceneName ||
                spiderRoomList[roomIndex].sceneName == currentRoom.stairSceneName ||
                spiderRoomList[roomIndex].sceneName == currentRoom.wall1SceneName ||
                spiderRoomList[roomIndex].sceneName == currentRoom.wall2SceneName ||
                spiderRoomList[roomIndex].sceneName == currentRoom.wall3SceneName ||
                spiderRoomList[roomIndex].sceneName == currentRoom.wall4SceneName ||
                spiderRoomList[roomIndex].sceneName == currentRoom.wall5SceneName)
            {
                return spiderRoomList[roomIndex];
            }
        }
